...
export const useLendasStore = create<LendasState>((set) => ({
  restaurant: {
    id: "rest_lendas_2018",
    name: "LENDAS 2018",
    slug: "lendas-2018",
  ...
  tableSession: {
    ...
    status: "ACTIVE",
    activeUsers: [
      { id: "user_joao", name: "Joao", active: true },
      { id: "user_maria", name: "Maria", active: true }
    ]
  },
  cart: [
    {
      id: "cart_carlos_burger",
      productName: "Hamburguer Lendas",
      customerName: "Carlos",
      quantity: 1,
      unitPrice: 29.9
    }
